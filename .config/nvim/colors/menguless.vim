...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Constant ctermbg=0 ctermfg=15 cterm=NONE guibg=#053230 guifg=#658354 gui=NONE
    ...
    hi Statement ctermbg=0 ctermfg=15 cterm=NONE guibg=#053230 guifg=#ddead1 gui=NONE
    ...
    hi Type ctermbg=0 ctermfg=15 cterm=NONE guibg=#053230 guifg=#658354 gui=NONE
